...
ME_HayEstudiantes:
    ...
    ; ===== Verificar división por cero antes de calcular porcentajes =====
    mov al, cnt
    cmp al, 0
    je ME_FinMostrar        ; Si cnt = 0, salir
...
ME_NoDecReprobados:
    ...
    ; Usar los decimales escalados del promedio
    mov bx, promedio_decimal      ; dec_lo (decimales escalados)
    mov cx, 0                     ; dec_hi (será 0 para el promedio)
    
    ; Solo mostrar si hay decimales significativos
    cmp bx, 0
    je ME_NoDecPromedio
