...
; Valida que la cadena tenga exactamente 3 palabras vÃ¡lidas
; ENTRADA: SI apunta al string del nombre completo
; SALIDA: AL = 1 si vÃ¡lido, AL = 0 si invÃ¡lido
; ============================================================    
...
; SALIDA: AL = 1 si vÃ¡lida, AL = 0 si invalida
; ============================================================
ValidarNota PROC
    push bx
    push cx
    ...
    ; Verificar si el string estÃ¡ vacÃ­o
    cmp BYTE PTR [si], '$'
    je VN_NotaInvalida
    cmp BYTE PTR [si], 13
    je VN_NotaInvalida
...
; SALIDA: CF=0 si Ã©xito, CF=1 si error
; ============================================================
ParseLineaNombreNota PROC
    ...
    ; Guardar SI original en el stack para restaurarlo despuÃ©s
    mov bp, sp
    mov [bp-2], si
    push si
...
PL_TrimEnd:
    ...
    ; Buscar el Ãºltimo espacio (separador nombre-nota)
PL_FindSplit:
    mov bx, di
PL_FindSpaceBack:
    cmp bx, si
...
PL_EndCopyNote:
    ...
    dec bx              ; BX apunta al Ãºltimo carÃ¡cter del nombre
...
PL_EndCopyName:
    ...
    ; Si llegamos aquÃ­, tanto nombre como nota son vÃ¡lidos
    pop si
    clc                 ; CF = 0 (Ã©xito)
    jmp PL_Fin
...
PL_NotaInvalida:
    ; El mensaje de error ya se mostrÃ³ en ValidarNota
    pop si
    stc                 ; CF = 1 (error)
    jmp PL_Fin

PL_NombreInvalido:
    ; El mensaje de error ya se mostrÃ³ en ValidarNombreCompleto
    pop si
    stc                 ; CF = 1 (error)
...
CE_Loop:
    ...
    ; Verificar aprobado/reprobado (70 o mÃ¡s aprueba)
    cmp ax, 70
    jl CE_Reprobado
    inc aprobados
...
; ============================================================
; Imprimir nÃºmero de 3 dÃ­gitos (0-100)
; Entrada: AX = nÃºmero
; ============================================================
